...
<style type="text/css">
	...
	#modal_wrap{ /*#:아이디*/
		...
		top:0;left: 0;right: 0; /*위치를 맨위로*/
		width: 100%;height: 100%; /*넓이, 높이*/
		margin: auto;/*가운데 정렬*/ 
		z-index: 9;
	}
	...
	display:none;
		...
		margin: auto; top:30px; left: 0; right: 0; width: 350px;height: 450px; background-color: rgba(212,244,250,0.9)
	...
	<table border="1">
		...
		<tr>
			<td colspan="4" align="center">
				<c:if test="${data.id == loginUser }"> <!-- 아이디와 작성자가 일치하냐 -->
				...
				<input type="button" onclick="location.href='${contextPath }/board/boardAllList'" value="리스트 이동">
			</td>
		</tr>
		<tr>
			<td colspan="4">
...
<!-- 답변 공간 만들기 -->
<div id="modal_wrap"> <!-- 답변의 큰 틀  -->
	<div id="first"> <!-- 입력받는 창 -->
		<div style="width:250px; margin:auto; padding-top:20px">
			<form id="frm"> 
				<b>글번호:</b><input type="text" name="write_no" value="${data.writeNo }" readonly>
				<hr>
				<b>작성자:</b>${loginUser }
				<hr>
				<b>제목:</b><br>
